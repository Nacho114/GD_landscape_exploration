...
for dim = dimensions
    ...
    for n_d = itr_nd
        ...
        estimation_errors(in_index) = L2_sample_estimation_error(dim, n_samples, w0_norm, learningRate, iterations, trials);
        in_index = in_index + 1;
    end
...
save('L2_estimation_error_iterations', 'estimation_error_cell', 'dimensions', 'iterations', 'lower_limit', 'step_size', 'upper_limit');
