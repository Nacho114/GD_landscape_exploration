...
for dim = dimensions
    ...
    for n_d = n_d_itr
        ...
        parfor i = 1:n_instances
            ...
            sample_variances(i) = L1_sample_var(dim, n_samples, w0_norm, learningRate, iterations, trials);
...
save('L1_success_rate_iterations_sqrtd', 'success_rate_cell', 'dimensions', 'iterations', 'lower_limit', 'step_size', 'upper_limit', 'dimensions');