function [ error_estimate ] = L1_sample_estimation_error( dim, n_samples, w0_norm, learningRate, iterations, trials )
    ...
    parfor i = 1:trials
        ...
        [w_est] = GD_L1_v(x, y, init_weights, learningRate, iterations, B0);
        w_estimates{i} = w_est;
    end
