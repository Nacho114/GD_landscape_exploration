...
for dim = dimensions
    ...
    for itr = num_itr
        ...
        parfor j = 1:n_instances      
            ...
            [w_est] = GD_L1_v(x, y, init_weights, learningRate, itr, B0);
            globabl_estimate = GD_L1_v(x, y, init_weights, learningRate, gl_iterations, B0);
...
save('L1_distance_vs_number_of_iterations', 'dist_vs_num_itr_cell', 'dimensions', 'gl_iterations', 'lower_limit', 'step_size', 'upper_limit', 'dimensions');